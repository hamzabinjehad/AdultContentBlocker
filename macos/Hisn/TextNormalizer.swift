...
public enum TextNormalizer {
    ...
    private static let invisible: Set<UInt32> = [
        ...
        // Also every other default-ignorable format character a page can put
        // between two letters to split a word the reader still sees whole: soft
        // hyphen, word joiner and invisible operators, bidi embeddings, overrides
        // and isolates, variation selectors, and the fillers. `p&shy;o&shy;r&shy;n`
        // renders as "porn" and tokenised as p / o / r / n before these were added.
        0x00ad, 0x034f, 0x180e, 0x2060, 0x2061, 0x2062, 0x2063, 0x2064,
        0x202a, 0x202b, 0x202c, 0x202d, 0x202e, 0x2066, 0x2067, 0x2068, 0x2069,
        0x206a, 0x206b, 0x206c, 0x206d, 0x206e, 0x206f, 0x115f, 0x1160, 0x3164, 0xffa0,
